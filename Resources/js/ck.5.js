var CK = function(t) {
    ...
    var f = function() {
        ...
        return e = t, (n = [{
            ...
            key: "confirmed",
            value: function() {
                var t = new CustomEvent("ckjs:guard:confirmed", {
                    bubbles: !0
                });
    ...
    var v = function() {
        function t(e) {
            ...
            }, [].concat(p(r), [l("style", {}, [h.a])]))), this.body.addEventListener("click", this.handleClick)
        }
        var e, n, r;
        return e = t, (n = [{
            key: "handleClick",
            ...
            value: function() {
                var t, e, n, r = this;
                t = this.body, e = function() {
                    r.toggle(r.body, !1)
                }, n = function() {
                    r.body.style.display = "none", r.body.dispatchEvent(new CustomEvent("ckjs:overlay:hide", {
                        bubbles: !0
                    }))
    ...
    var j = function() {
            function t(e) {
                ...
                ! function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, t), this.hide = this.hide.bind(this), this.show = this.show.bind(this), this.insertIntoDOM = this.insertIntoDOM.bind(this), this.element = e, this.parent = e.parentElement, this.body = (n = {
            ...
            return e = t, (n = [{
                ...
                value: function(t) {
                    ...
                    document.body.contains(e) || (e = document.body), e.appendChild(this.overlay.body)
                }
            }, {
                key: "show",
                value: function() {
            ...
            return e = t, (n = [{
                ...
                value: function(t, e) {
                    var n = new f(t),
                        ...
                        i = r.offsetHeight;
                    n.body.style.height = "0px", this.modal.body.appendChild(n.body), n.body.addEventListener("ckjs:guard:loaded", (function() {
                        r.style.height = "0px"
                        ...
                        n.body.remove(), r.style.height = "".concat(i, "px"), e && e()
                    }))
                }
    ...
    var D = function() {
        function t(e) {
            ...
            ! function(t, e) {
                ...
                var n = new f(t),
                    r = new j(n.body);
                r.body.style.height = "0px", r.body.classList.add("guard"), r.insertIntoDOM(document.body), r.show(), n.body.addEventListener("ckjs:guard:size", (function(t) {
        ...
        return e = t, (n = [{
            ...
            value: function() {
                ...
                this.body = (t = {
                    ...
                    "aria-label": "Close"
                }, ["✕"])].concat(I(e), [l("style", {}, [L.a])]))), this.insertIntoDOM(), this.configureLinks(), this.canDisplayOnce() && this.canDisplayOnDevice() && this.configureTrigger()
            }
        }, {
            key: "canDisplayOnce",
            value: function() {
    ...
    var z = function() {
            ...
            return e = t, (n = [{
                ...
                value: function(t, e) {
                    var n = new f(t),
                        r = new j(n.body);
                    r.body.style.height = "0px", r.body.classList.add("guard"), r.insertIntoDOM(this.form.body), r.show(), n.body.addEventListener("ckjs:guard:size", (function(t) {
                        r.body.style.height = "".concat(t.detail.height, "px")
                    })), n.body.addEventListener("ckjs:guard:confirmed", (function() {
                        r.hide()
                    })), r.overlay.body.addEventListener("ckjs:overlay:hide", (function() {
    ...
    var N = function() {
        ...
        return e = t, (n = [{
            ...
            value: function() {
                ...
                this.body = (t = {
                ...
                }, e = t.position, n = t.children, l("div", {
                    ...
                    "aria-label": "Close"
                }, ["✕"])].concat(F(n), [l("style", {}, [q.a])]))), this.insertIntoDOM(), this.configureLinks(), this.canDisplayOnce() && this.canDisplayOnDevice() && this.configureTrigger()
            }
        }, {
            key: "canDisplayOnce",
            value: function() {
        ...
        function t(e) {
            ...
            ! function(t, e) {
                ...
                switch (i.action) {
                    ...
                    case "custom_content":
                        return t = n.body, e = i.customContent, (r = l("div", {
                ...
                var t = At(a.a.mark((function t(e) {
                    ...
                    return a.a.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            ...
                            case 3:
                                return r = t.sent, i = n.body, o = new FormData(i), s = document.referrer, o.append("token", r), o.append("referrer", s), o.append("user", ht()), t.prev = 10, c = fetch(i.action, {
                                    method: "POST",
                                    body: o,
                                    headers: {
                                        Accept: "application/json"
                                    }
                                }), n.submitting(), t.t0 = n, t.t1 = i, t.next = 17, c;
                            case 17:
                                t.t2 = t.sent, t.t0.process.call(t.t0, t.t1, t.t2), t.next = 25;
                                break;
                            case 21:
                                t.prev = 21, t.t3 = t.catch(10), n.finished(), n.errors({
                                    fields: ["server"],
                                    messages: [t.t3]
                                });
                            case 25:
                ...
                var t = At(a.a.mark((function t(e, r) {
                    ...
                    return a.a.wrap((function(t) {
                        for (;;) switch (t.prev = t.next) {
                            ...
                            case 5:
                                i = t.sent, t.t0 = i.status, t.next = "success" === t.t0 ? 9 : "quarantined" === t.t0 ? 11 : 13;
                                break;
                            case 9:
                ...
                if (yt(n.config.uid), t.consent.enabled) return n.format.guard(t.consent.url, (function() {
                    n.afterSubscribe(t)
                }));
                n.afterSubscribe(t)
                ...
                if ("quarantined" != t.status) {
                    ...
                    if ("redirect" !== e.action) {
                        ...
                        r.className = "formkit-alert formkit-alert-success", r.dataset.element = "success", r.dataset.group = "alert", r.innerText = e.message;
                        var i = n.body.querySelector("[data-element='fields']") || n.body;
            ...
            }, this.body = e, this.hidden = !1, this.config = new at(Ot(e)), this.recaptcha = new ft(this.config.recaptcha), this.format = new r[this.config.format](this), this.template = i[this.config.template] ? new i[this.config.template](this) : new H(this), this.initialize.call(this)
        }
        var e, n, o;
        return e = t, (n = [{
            key: "initialize",
    ...
    /comp|inter|loaded/.test(document.readyState) ? Lt() : document.addEventListener("DOMContentLoaded", (function() {
        Lt()
    }))
}]);